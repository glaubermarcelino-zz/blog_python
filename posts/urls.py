...
urlpatterns = [
    ...
    path("Adicionar/", AddPost.as_view(), name="add_post"),
    path("Adicionar/drafts/", PostDraftsList.as_view(), name="list_drafts"),
    path("buscar/", SearchPosts.as_view(), name="search"),
    # post archives
    ...
    path("categoria/<str:name>/", ListaPorCategoria.as_view(), name="Categoria"),
    path("autor/<str:autor>/", ListByAuthor.as_view(), name="author"),
